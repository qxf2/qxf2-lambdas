...
LAMBDA_ZIP='./comment_reviewer.zip'
LAMBDA_FOLDER_PATH = '../../comment_reviewer'
REQUIREMENTS_FILE_PATH = '../../comment_reviewer/requirements.txt'
...
def invoke_function_and_get_comment_reviewer(function_name, event):
