...
LAMBDA_ZIP='./holiday_reminder.zip'
LAMBDA_FOLDER_PATH = '../../holiday_reminder'
REQUIREMENTS_FILE_PATH = '../../holiday_reminder/requirements.txt'
...
def invoke_function_and_get_upcoming_holiday(function_name, event):
