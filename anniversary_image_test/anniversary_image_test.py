...
def get_text_and_compare(file):
    ...
    matched_emp_db_data = check_employee_work_anniversary(splitted_text)
    ...
    if matched_emp_db_data is not None:
        ...
        print("No employee anniversary today")
        sys.exit()
...
def check_employee_work_anniversary(splitted_text):
...
def lambda_handler(event, context):
    "lambda entry point"
    ANNIVERSARY_IMAGE = 'work_anniversary_rd.png'
    get_text_and_compare(ANNIVERSARY_IMAGE)
