...
import os
import boto3
QUEUE_URL = 'httpssqs.ap-south-1.amazonaws.com285993504765skype-sender'
at_Qxf2Bot = 'at id=8live.cid.92bd244e945d8335qxf2botat!'
...
def get_reply()
    ...
    reply = f'First comment reviewer {first_comment_reviewer}nnSecond comment reviewer {second_comment_reviewer}n'
