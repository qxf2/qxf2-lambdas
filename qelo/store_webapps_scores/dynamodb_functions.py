"""
Module to contain DynamoDB operations related to webapps sub-streams
scores calculation functionality of QElo.
"""
import boto3
...
def read_webapps_table(table_name, date, substreams):
    "Retrieves items that match the criteria, from corresponding webapps DynamoDB table."
    data = [] #list of dicts
    # Initialize the DynamoDB table resource.
    table = init_table(table_name)
    try:
